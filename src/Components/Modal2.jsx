  ...
  return (
    <dialog id="modal2" className="modal modal-bottom sm:modal-middle">
      <div className="modal-box">
        <h3 className="font-bold text-3xl mb-4 text-[#071952]">Register for {camp.campName}</h3>
        <div className="">
          <form onSubmit={handleRegistration}>
            <input type="hidden" name="campName" value={camp.campName} readOnly />
            <input type="hidden" name="fees" value={camp.campFees} readOnly />
            <input type="hidden" name="location" value={camp.location} readOnly />
            <input type="hidden" name="healthcareProfessional" value={camp.healthcareProfessionalName} readOnly />
            ...
            <div className="modal-action">
              ...
              <button type="button" className="btn w-20 bg-blue-500 text-white" onClick={() => document.getElementById('modal2').close()}>Close</button>
            </div>
          </form>
        </div>
      </div>
